...
- release hygiene checks: generated review artifacts include public issue context preview and task materialization validation evidence; live LLM calibration remains the only warning,
