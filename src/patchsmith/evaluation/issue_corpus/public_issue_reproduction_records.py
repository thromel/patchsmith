"""Per-record public issue reproduction execution."""
...
from patchsmith.evaluation_models import IssueCorpusPublicReproductionExecutionResult
...
def execute_public_issue_reproduction_record(
    *,
    record: dict[str, Any],
    run_logs_dir: Path,
    runner: Any | None,
...
__all__ = ["execute_public_issue_reproduction_record"]
