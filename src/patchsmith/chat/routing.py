...
# Natural-language phrase -> slash command. Defined once at import time since it
# is consulted on every line of chat input.
...
def route_natural_command(raw: str) -> str | None:
    ...
    if normalized in _EXACT_ROUTES:
        return _EXACT_ROUTES[normalized]
